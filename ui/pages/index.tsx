  ...
  return (
      <Stack mt={5}>
          ...
          <Text pl={4}>
              ...
              <br />
              We provide many fun challenges of varying difficulty and categories,
              and none of them require any guessing skills.
          </Text>
          ...
          <Stack pl={4}>
              <UnorderedList pl={4}>
                  <ListItem><Text fontWeight="bold">1st: 800 USD</Text></ListItem>
                  <ListItem><Text fontWeight="bold">2nd: 500 USD</Text></ListItem>
                  <ListItem><Text fontWeight="bold">3rd: 300 USD</Text></ListItem>
                  <ListItem><Text fontWeight="bold">4th: 200 USD</Text></ListItem>
                  <ListItem><Text fontWeight="bold">5th: 200 USD</Text></ListItem>
              </UnorderedList>
          </Stack>
          ...
          <Text pl={4}>
              <UnorderedList>
                  ...
                  <ListItem>
                      Anyone can participate in this CTF:
                      no restriction on your age or nationality.
                  </ListItem>
                  <ListItem>
                      Your rank on the scoreboard depends on: 1) your total
                      number of points (higher is better); 2) the timestamp
                      of your last solved challenge (erlier is better).
                  </ListItem>
                  <ListItem>
                  ...
                  <ListItem>
                      You can't brute-force the flags. If you submit 5 incorrect flags in a
                  ...
                  <ListItem>
                      We reserve the right to ban and disqualify any teams breaking
                      any of these rules.
                  </ListItem>
                  <ListItem>
                      The flag format is{" "}
